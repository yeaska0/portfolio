...
const TR = {
    ...
    ru: {
        ...
        ap2: 'Знаю <strong>4 языка программирования</strong>: Java (основной), Python, C++ и SQL. Работаю на <strong>MacBook Air M4</strong> — быстрые сборки, чистый воркфлоу.',
        ...
        sl2: 'Языки', se: 'С года', sd: 'Мотивация', su2: 'Инструменты',
        su: 'Моё оборудование',
    ...
    kz: {
        ...
        hn1: 'Ерасыл', hr: 'Backend-инженер',
        hd: 'Қазақстандық backend бағытындағы бағдарламашы студент. Java, Python және SQL жобалар жасаймын. Масштабталатын жүйелерге, API және дерекқорларға құштармын.',
        ...
        ap2: '<strong>4 бағдарламалау тілін</strong> білемін: Java (негізгі), Python, C++ және SQL. <strong>MacBook Air M4</strong>-те жұмыс жасаймын — жылдам сборка, таза воркфлоу.',
